...
import 'package:carwash_app/widgets/dashed_line.dart';
import 'package:carwash_app/widgets/carwash_booking_cancellation_dialog.dart';

class CarwashBookingStateWidget extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return BlocBuilder(
      bloc: BlocProvider.of<CarwashBookingBloc>(context),
      builder: (context, state) {
        int selectedTab = 1;
        CarwashBookingState currentState = state;
        String title = "";
        if (state is CarwashBookingLoadingState) {
