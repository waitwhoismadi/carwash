...
import 'package:carwash_app/models/payment_method.dart';
import 'package:carwash_app/widgets/rounded_button.dart';

class CarwashBookingPaymentsWidget extends StatefulWidget {
  @override
  _CarwashBookingPaymentsWidgetState createState() =>
      _CarwashBookingPaymentsWidgetState();
}

class _CarwashBookingPaymentsWidgetState
    extends State<CarwashBookingPaymentsWidget> {
  ...
  void initState() {
    super.initState();
    methods = (BlocProvider.of<CarwashBookingBloc>(context).state
